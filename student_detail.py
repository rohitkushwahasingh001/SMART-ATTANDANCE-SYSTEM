...
class Student:
    def __init__(self,root):
        ...
        img=Image.open("SmartAttendance-main\Images/students.jpg")
        ...
        img1=Image.open("SmartAttendance-main\Images/facere.jpg")
        ...
        img2=Image.open("SmartAttendance-main\Images/stdents2.jpg")
            ...
            try:
                ...
                while(True):
                    ...
                    for(x,y,w,h) in faces:
                        ...
                        cv2.imwrite("SmartAttendance-main/data/image." + str(id) + '.' +
